...
export default function PopupForm({ isOpen, onClose, destinationName }) {
  ...
  const popupContent = (
    <div className="fixed inset-0 z-[9999] pop flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-fadeIn">
      ...
      {/* Popup Card - Premium Design */}
      <div className="relative bg-white rounded-3xl shadow-2xl max-w-md w-full animate-scaleIn overflow-hidden border border-orange-100/50">
        ...
        <div className="p-6 sm:p-8">
          {submitted ? (
            ...
            <div className="text-center py-6">
              ...
              <p className="text-gray-500 text-sm">We'll reach out within 2 hours.</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3.5 text-sm focus:outline-none focus:border-orange-400 focus:ring-4 focus:ring-orange-400/10 transition-all placeholder:text-gray-400"
                ...
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="relative w-full py-3.5 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white font-semibold text-sm rounded-xl shadow-lg shadow-orange-500/30 flex items-center justify-center gap-2 transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed hover:scale-[1.02] active:scale-[0.98] group overflow-hidden"
                >
